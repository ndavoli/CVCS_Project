"""
VGG-16 on PlantVillage dataset — train, evaluate, save metrics.
Uses torchvision's VGG-16 (trained from scratch).
"""
...
WEIGHTS_DIR = "/homes/ndavoli/vgg/weights"
METRICS_PATH = "/homes/ndavoli/vgg/metrics.json"

BATCH_SIZE = 64          # smaller than AlexNet — VGG uses more memory
NUM_EPOCHS = 30
LR = 0.01
MOMENTUM = 0.9
WEIGHT_DECAY = 5e-4
...
# Deterministic train/test split (same seed as AlexNet for fair comparison)
...
# ──────────────────────────── Model ─────────────────────────────
# VGG-16 from scratch, adjust final layer to our number of classes
...
weights_path = os.path.join(WEIGHTS_DIR, "vgg16.pth")
