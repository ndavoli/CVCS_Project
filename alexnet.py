"""
AlexNet on PlantVillage dataset — train, evaluate, save metrics.
Uses torchvision's pretrained-weight-free AlexNet (trained from scratch).
"""
...
WEIGHTS_DIR = "/homes/ndavoli/alexnet/weights"
METRICS_PATH = "/homes/ndavoli/alexnet/metrics.json"
...
# ──────────────────────────── Data ──────────────────────────────
# AlexNet expects 224×224 input
train_transform = transforms.Compose([
    transforms.RandomResizedCrop(224),
    transforms.RandomHorizontalFlip(),
    transforms.ToTensor(),
    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225]),     # standard ImageNet normalization for better convergence
])
...
# ──────────────────────────── Model ─────────────────────────────
# AlexNet from scratch, adjust final layer to our number of classes
...
weights_path = os.path.join(WEIGHTS_DIR, "alexnet.pth")
